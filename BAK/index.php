...
<div class="modal fade" id="subscribe" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-md">
		<div class="modal-content">
			...
			<h5 class="modal-title">Subrscribe Now!</h5>
...
<div class="container">
    <div class="container container_letter">
			...
			$img_query = "SELECT * FROM attachments WHERE id='$id_img'";
			...
			<div class="row d-flex justify-content-between align-items-center text_description">
				<div class="col-md-12">
					<div id="news-slider" class="owl-carousel">
						...
						$id2 = $v2['id'];
						$query_issue = $pdo->query("SELECT * FROM newsletter WHERE issue_month = '$id2' LIMIT 1");
						$issue_fetch = $query_issue->fetchAll();
						foreach($issue_fetch as $issue_row){
							$attachment = $issue_row['attachment'];
						}
						$attach_query = $pdo->query("SELECT * FROM `attachments` WHERE `id` = '$attachment'");
						...
						<div class="post-slide">
							<div class="post-img">
								...
								<img src="" alt="">
								<a href="./index.php?issue_id=<?php echo $v2['id'];?>" class="over-layer"><i class="fa fa-link"><?php //echo $issue_row['attachment'];?></i></a>
							</div>
							<div class="post-content">
								<h3 class="post-title">
									<a href="./index.php?issue_id=<?php echo $v2['id'];?>">
										<?php  
											$monthName = date('F', mktime(0, 0, 0, $v2["month"], 10)); 
											echo 'VOL. '.$v2['vol_number'].' NO. '.$v2["issue_id"];
											$range = date("d",strtotime($v2['date_from'])).'-'.date("d F Y",strtotime($v2['date_to'])); 
											echo '<br> '.$range.'';
										?>
									</a>
								</h3>
